...
<br/>
{{ Form::open(array('url' => '/buscar', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'search')) }}
			...
			<div class="row">
				<div class="col-xs-11">
			        ...
			        <div class="form-group">
                		...
                		<div class="col-md-8">
                    	{{ Form::text('empresario', null, array('placeholder' => 'Empresario', 'class' => 'form-control getEmpresario', 'data-url' => 'empresario', 'data-cod' => 'idEmpresario')) }}
                		</div>
				    </div>
	            </div>
            </div>
...
<br/>
			<div class="row">
				    ...
				    <div class="col-xs-6">
				    	<br/>
				        <center>
				        <a  href="{{ route('capterminos.create') }}" tabindex="11" class="btn btn-danger">
				        Siguiente
