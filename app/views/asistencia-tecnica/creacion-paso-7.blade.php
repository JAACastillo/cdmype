				...
				<div class="col-xs-12">
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-md-3">
	                        ...
	                        {{ Form::number('pago', $atcontrato->pago, array('class' => 'form-control text-center', 'min' => '1', 'max' => '1000', 'step' => 'any')) }}
	                    	</div>
	                    </div>
	                </div>
	                <div class="form-group">
	                    ...
	                    <div class="col-md-3">
	                    	<div class="input-group">
	                        {{ Form::number('aporte', $atcontrato->aporte, array('class' => 'form-control text-center', 'min' => '0', 'max' => '1000', 'step' => 'any')) }}
	                        <div class="input-group-addon">%</div>
	                    	</div>
	                    </div>
	                </div>
